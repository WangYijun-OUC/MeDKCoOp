...
class BTMRI1v2(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, 'brain-tumor-mri-dataset')
        self.split_path = os.path.join(self.dataset_dir, "split_BTMRI1.json")
